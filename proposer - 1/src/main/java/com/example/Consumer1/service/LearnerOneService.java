...
import com.example.Consumer1.util.WordCountResult;
...
@Service
public class LearnerOneService {

    final static Logger LOGGER = LoggerFactory.getLogger(LearnerOneService.class);
    ...
    public LearnerOneService(SidecarService sidecarService) {
