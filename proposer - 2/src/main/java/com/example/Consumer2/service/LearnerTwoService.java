...
@Service
public class LearnerTwoService {

    final static Logger LOGGER = LoggerFactory.getLogger(LearnerTwoService.class);
    ...
    public LearnerTwoService(SidecarService sidecarService) {
