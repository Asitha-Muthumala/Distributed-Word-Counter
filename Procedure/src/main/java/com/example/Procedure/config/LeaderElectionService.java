...
import com.example.Procedure.util.NodeInfo;
...
public class LeaderElectionService {
    ...
    public void sendHeartbeat() {
        ...
        LOGGER.info("Heartbeat sent - LeaderElectionService: {}", leaderElectTopic);
    }
    ...
    public boolean isLeader() {
        return nodeId.equalsIgnoreCase(currentLeaderId);
    }
}
